...
dat$employer <- factor(ifelse(dat$employer=="-oth-",
                              rep(8, nrow(dat)),
...
```{r beliefs, fig.cap="Participants' beliefs regarding behavior change." }
########################################################################
...
meansDiamondPlot(dat,
                 ...
                 conf.level=.9999,
                 dataSize=2, dataAlpha=.33, jitterWidth=.4, jitterHeight=.4,
                 xlab="Scores and 99.99% confidence intervals for the means")

ggsave(file=file.path(workingPath, 'figure 2.png'),
...
```{r beliefs-compared, fig.cap="Participants' beliefs regarding behavior change separate for participants who are close or distant from behavior change science." }

ggplot() + theme_bw() +
  rawDataDiamondLayer(dat[dat$role_dichotomous=='Close',],
                      items=relevantStatements[sortOrder],
                      dataColor = "blue", size=4,
                      dataAlpha=.1, jitterWidth=.4, jitterHeight=.4) +
  rawDataDiamondLayer(dat[dat$role_dichotomous=='Distant',],
                      items=relevantStatements[sortOrder],
                      dataColor = "red", size=4,
                      dataAlpha=.1, jitterWidth=.4, jitterHeight=.4) +
  meansDiamondPlot(dat[dat$role_dichotomous=='Close',],
                   items=relevantStatements[sortOrder],
                   labels=statements[sortOrder],
                   conf.level=.9999, color="blue", alpha = .33,
                   returnLayerOnly = TRUE) +
  meansDiamondPlot(dat[dat$role_dichotomous=='Distant',],
                   items=relevantStatements[sortOrder],
                   labels=statements[sortOrder],
                   conf.level=.9999, color="red", alpha = .33,
                   returnLayerOnly = TRUE) +
  scale_x_continuous(breaks=1:7,
                     name="Scores and 99% confidence intervals for the means") +
  scale_y_continuous(breaks=seq_along(statements[sortOrder]),
                     labels=statements[sortOrder],
                     name=element_blank());

ggsave(file=file.path(workingPath, 'figure 2B (supplemental).png'),
       width=18, height=16, units='cm', dpi=300,
       type='cairo');
...
```{r indices, fig.cap="Participants' belief indices regarding behavior change." }
########################################################################
### Compute indices
########################################################################
...
ggsave(file=file.path(workingPath, 'figure 2C (supplemental).png'),
       width=18, height=16, units='cm', dpi=300,
       type='cairo');
...
```{r indices-compared, fig.cap="Participants' belief indices regarding behavior change, separate for participants close to or distant from behavior change science." }
...
ggplot() + theme_bw() +
  ...
  meansDiamondPlot(dat[dat$role_dichotomous=='Close',],
                   items=names(scales)[sortOrder],
                   labels=statements[sortOrder],
                   conf.level=.99, color="blue", alpha = .33,
                   returnLayerOnly = TRUE) +
  meansDiamondPlot(dat[dat$role_dichotomous=='Distant',],
                   items=names(scales)[sortOrder],
                   labels=statements[sortOrder],
                   conf.level=.99, color="red", alpha = .33,
                   returnLayerOnly = TRUE) +
  scale_x_continuous(breaks=1:7,
                     name="Scores and 99% confidence intervals for the means") +
  scale_y_continuous(breaks=seq_along(names(scales)[sortOrder]),
                     labels=names(scales)[sortOrder],
                     name=element_blank());

ggsave(file=file.path(workingPath, 'figure 2D (supplemental).png'),
       width=18, height=16, units='cm', dpi=300,
       type='cairo');
